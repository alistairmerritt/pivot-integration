...
from .const import DOMAIN, CONF_DEVICE_SUFFIX, get_text_definitions, get_color_text_definitions, get_timer_text_definitions, get_configured_color_text_definitions
...
async def async_setup_entry(
    ...
    async_add_entities([
        ...
        for defn in get_text_definitions(suffix) + get_color_text_definitions(suffix) + get_timer_text_definitions(suffix) + get_configured_color_text_definitions(suffix)
    ])
